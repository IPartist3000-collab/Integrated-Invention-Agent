...
export default function App() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!jsonMatch) throw new Error("결과 해석 중 오류가 발생했습니다.");
  ...
  // === 3. UI 레이아웃: 제공해주신 전주기 에이전트 인터페이스 유지 ===
  return (
